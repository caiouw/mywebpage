...
function addEmployees() {
  let emp1 = {
    ...
    daysworked: 29.00,
    dailyrate: 300.00,
    grosspay: (29.00 * 300.00).toFixed(2),
    deduction: 50.00,
    netpay: ((29.00 * 300.00) - 50.00).toFixed(2),
  };
  payroll.push(emp1);
  let emp2 = {
    name: "Jane Doe",
    daysworked: 25.00,
    dailyrate: 350.00,
    grosspay: (25.00 * 350.00).toFixed(2),
    deduction: 40.00,
    netpay: ((25.00 * 350.00) - 40.00).toFixed(2),
  };
  payroll.push(emp2);
  let emp3 = {
    name: "Haw K. Tuah",
    daysworked: 69.00,
    dailyrate: 420.00,
    grosspay: (69.00 * 420.00).toFixed(2),
    deduction: 20.00,
    netpay: ((15.00 * 550.00) - 20.00).toFixed(2),
  };
  payroll.push(emp3);
}
